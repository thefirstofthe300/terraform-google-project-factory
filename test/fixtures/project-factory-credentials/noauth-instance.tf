...
//      private_key = "${file(local.ssh_pkey_path)}"
//    }
//  }
//
//  provisioner "file" {
...
//}
//
//resource "null_resource" "wait_for_jenkins_configuration_noauth" {
//  provisioner "local-exec" {
//    command = "${path.module}/scripts/wait-for-vm.sh ${var.project_id} ${google_compute_instance.noauth.zone} ${google_compute_instance.noauth.name}"
//  }
//
//  depends_on = ["google_compute_instance.noauth"]
//}
